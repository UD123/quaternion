from quarternion_wynn.quaternion import Quaternion


# Create a quaternion representing a rotation of +90 degrees about positive y axis.
my_quaternion = Quaternion(axis=[0, 1, 0], degrees=90)
...
null_quaternion = Quaternion(axis=[0, 1, 0], angle=0)

print('\nInterpolated Rotation')
print('---------------------')

# The following will create a sequence of 9 intermediate quaternion rotation objects
for q in Quaternion.intermediates(null_quaternion, my_quaternion, 9, include_endpoints=True):
